'use strict';
// based on https://github.com/wildlyinaccurate/angular-readable-time/blob/master/angular-readable-time.js
angular.module('poligloMonitorApp').filter('readableTime', function() {
